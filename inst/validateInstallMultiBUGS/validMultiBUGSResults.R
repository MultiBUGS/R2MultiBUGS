structure(list(Air = structure(c(13.475, 27.37549, 40.81623, 
-0.84648, 0.0435, 8.69959, 7.45923, 8.83783, 3.01268, 0.11018, 
-3.781, 12.88, 23.37975, -4.50322, -0.0263, 7.569, 22.42, 34.89, 
-1.27, 0.02274, 13.51, 27.27, 40.84, -0.6692, 0.03729, 19.4, 
32.22, 46.75, -0.281, 0.05947, 30.5305, 42.32, 58.19, 0.86515, 
0.1835), .Dim = c(5L, 7L), .Dimnames = list(c("X[1]", "X[2]", 
"X[3]", "theta[1]", "theta[2]"), c("mean", "sd", "2.5%", "25%", 
"50%", "75%", "97.5%"))), Asia = structure(c(1.80567, 1.1796, 
1.09627, 0.3957, 0.38387, 0.29497, 1, 1, 1, 2, 1, 1, 2, 1, 1, 
2, 1, 1, 2, 2, 2), .Dim = c(3L, 7L), .Dimnames = list(c("bronchitis", 
"either", "lung.cancer"), c("mean", "sd", "2.5%", "25%", "50%", 
"75%", "97.5%"))), Beetles = structure(c(-60.84128, 34.34082, 
3.55968, 9.9372, 22.49228, 33.89956, 50.05576, 53.22377, 59.15038, 
58.68728, 5.20131, 2.92457, 0.95333, 1.67812, 2.08476, 1.75341, 
1.66439, 1.11958, 0.74766, 0.43332, -71.28075, 28.74975, 1.982, 
6.919, 18.45, 30.43, 46.68, 50.84, 57.49, 57.69, -64.33, 32.3375, 
2.881, 8.758, 21.04, 32.71, 48.95, 52.5, 58.69, 58.44, -60.71, 
34.27, 3.46, 9.849, 22.47, 33.91, 50.1, 53.31, 59.23, 58.74, 
-57.28, 36.3125, 4.132, 11.02, 23.92, 35.09, 51.21, 54.01, 59.6825, 
59, -50.92, 40.26025, 5.69105, 13.43025, 26.64, 37.26, 53.13, 
55.19025, 60.39, 59.36), .Dim = c(10L, 7L), .Dimnames = list(
    c("alpha", "beta", "rhat[1]", "rhat[2]", "rhat[3]", "rhat[4]", 
    "rhat[5]", "rhat[6]", "rhat[7]", "rhat[8]"), c("mean", "sd", 
    "2.5%", "25%", "50%", "75%", "97.5%"))), BiRats = structure(c(106.56034, 
...
"75%", "97.5%"))), Camel = structure(c(3.199, 0.11791, 0.11791, 
3.22327, 0.03519, 0.84975, -0.03162, -0.03162, 0.84991, 2.0602, 
2.46612, 2.46612, 2.13682, 0.65527, 0.50303, 0.69675, 0.69675, 
0.50508, 1.13, -4.57602, -4.57602, 1.11997, -0.9017, 0.22159, 
-1.38405, -1.38405, 0.2153, 1.93675, -1.571, -1.571, 1.921, -0.65055, 
0.4941, -0.49565, -0.49565, 0.4931, 2.663, 0.23045, 0.23045, 
2.662, 0.10835, 0.7321, -0.04676, -0.04676, 0.73415, 3.804, 1.777, 
1.777, 3.848, 0.6978, 1.08225, 0.4324, 0.4324, 1.079, 8.43205, 
4.69405, 4.69405, 8.66835, 0.9054, 2.13005, 1.346, 1.346, 2.16
), .Dim = c(9L, 7L), .Dimnames = list(c("Sigma2[1,1]", "Sigma2[1,2]", 
"Sigma2[2,1]", "Sigma2[2,2]", "rho", "tau[1,1]", "tau[1,2]", 
"tau[2,1]", "tau[2,2]"), c("mean", "sd", "2.5%", "25%", "50%", 
"75%", "97.5%"))), Dugongs = structure(c(1.85767, 2.64973, 0.96989, 
0.86209, 0.09887, 0.26392, 0.07107, 0.07684, 0.03153, 0.0148, 
1.323, 2.528, 0.8224, 0.7898, 0.07502, 1.701, 2.604, 0.9188, 
0.8457, 0.08841, 1.854, 2.642, 0.9689, 0.8646, 0.09723, 2.026, 
2.691, 1.018, 0.8836, 0.1074, 2.36802, 2.802, 1.122, 0.9144, 
0.1326), .Dim = c(5L, 7L), .Dimnames = list(c("U3", "alpha", 
"beta", "gamma", "sigma"), c("mean", "sd", "2.5%", "25%", "50%", 
"75%", "97.5%"))), Dyes = structure(c(2399.81116, 2970.23731, 
...
3466, 1539, 10140.49952, 5596.37451, 1570), .Dim = c(3L, 7L), .Dimnames = list(
    ...
    "2.5%", "25%", "50%", "75%", "97.5%"))), Equiv = structure(c(0.99767, 
...
"50%", "75%", "97.5%"))), Eyes = structure(c(0.6029, 0.3971, 
536.75923, 548.90934, 3.75937, 0.08421, 0.08421, 0.92221, 1.21365, 
0.6111, 0.4326, 0.2359, 535.1, 546.5, 2.917, 0.54737, 0.34, 536.2, 
548.2, 3.36175, 0.6039, 0.3961, 536.7, 548.9, 3.654, 0.66, 0.45262, 
...
))), Line = structure(c(2.99564, 0.79689, 1.02513, 0.56926, 0.39621, 
...
), c("mean", "sd", "2.5%", "25%", "50%", "75%", "97.5%"))), OtreesMVN = structure(c(5.26188, 
...
"2.5%", "25%", "50%", "75%", "97.5%"))), Rats = structure(c(106.61227, 
...
6.386, 113.6, 6.394, 7.106), .Dim = c(3L, 7L), .Dimnames = list(
    ...
    "50%", "75%", "97.5%"))), Stacks = structure(c(0.71462, 1.2978, 
-0.15277, -39.85965, 0.0106, 0.05567, 0.3192, 0.0106, 0.05567, 
0.3192, 0.0106, 0.05567, 0.3192, 3.38943, 0.14307, 0.38863, 0.16594, 
...
"sd", "2.5%", "25%", "50%", "75%", "97.5%"))), Surgical = structure(c(0.02054, 
...
0.1544, 0.1578, 0.09787), .Dim = c(12L, 7L), .Dimnames = list(
    ...
    "2.5%", "25%", "50%", "75%", "97.5%"))), Surgicalrand = structure(c(0.05312, 
...
"2.5%", "25%", "50%", "75%", "97.5%")))), .Names = c("Air", "Asia", 
"Beetles", "BiRats", "Camel", "Dugongs", "Dyes", "Equiv", "Eyes", 
"Line", "OtreesMVN", "Rats", "Stacks", "Surgical", "Surgicalrand"
))
